    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <main>
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 sm:pb-24 sm:pt-28 lg:px-8 lg:pb-32 lg:pt-36">
                        ...
                        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                            <button 
                                ...
                                className="group flex w-full items-center justify-center gap-2 rounded-md bg-emerald-500 px-6 py-3 text-sm font-semibold text-black transition hover:bg-emerald-400 sm:w-auto"
                            >
                                Start Trading
                                <ArrowRight
                                    size={17}
                            ...
                            <button 
                                ...
                                className="w-full rounded-md border border-zinc-800 px-6 py-3 text-sm font-medium text-zinc-300 transition hover:border-zinc-700 hover:bg-zinc-900 hover:text-white sm:w-auto"
                            >
                                Explore Markets
                            </button>
                        </div>
                ...
                {/* Features */}
                <section id="features" className="border-t border-zinc-800 bg-[#0d0d0d]">
                    <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
                        <div className="max-w-2xl">
                            <p className="text-sm font-medium text-emerald-400">Everything you need</p>
                            <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">Built for modern trading.</h2>
                            <p className="mt-4 text-zinc-400">
                                A focused trading experience with the tools you actually need to monitor and manage your investments.
                            </p>
                        </div>
                        <div className="mt-12 grid gap-px overflow-hidden rounded-xl border border-zinc-800 bg-zinc-800 sm:grid-cols-2 lg:grid-cols-4">
                            <Feature icon={<LineChart size={20} />} title="Live Markets" description="Track market prices with real-time updates." />
                            <Feature icon={<BriefcaseBusiness size={20} />} title="Portfolio" description="Monitor your holdings and profit or loss." />
                            <Feature icon={<Eye size={20} />} title="Watchlist" description="Keep your favorite assets within reach." />
                            <Feature icon={<BarChart3 size={20} />} title="Market Data" description="Analyze prices and make informed decisions." />
                        </div>
                    </div>
                </section>
                ...
                <section id="about" className="border-t border-zinc-800">
                    <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 lg:py-28">
                        <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">Ready to enter the market?</h2>
                        <p className="mx-auto mt-4 max-w-xl text-zinc-400">
                            Start building your portfolio and experience real-time market tracking with TradeForge.
                        </p>
                        <button 
                            onClick={() => navigate(token ? "/dashboard" : "/signup")}
                            className="mt-8 inline-flex items-center gap-2 rounded-md bg-white px-6 py-3 text-sm font-semibold text-black transition hover:bg-zinc-200"
                        >
                            Get Started
                            <ArrowRight size={17} />
                        </button>
            ...
            <footer className="border-t border-zinc-800">
                <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-6 text-xs text-zinc-600 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
                    <span>© {new Date().getFullYear()} TradeForge</span>
    ...
    return (
        <div className="flex items-center justify-between rounded-md px-3 py-3 transition hover:bg-zinc-900">
            <div>
                ...
                <p className="mt-0.5 text-xs text-zinc-600">NSE</p>
            </div>
            <div className="text-right">
                <p className="text-sm">{price}</p>
                <p className={`mt-0.5 text-xs ${positive ? "text-emerald-400" : "text-red-400"}`}>{change}</p>
            </div>
        </div>
    );
}
